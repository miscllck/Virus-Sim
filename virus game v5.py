...
#Enhance user experience by managing how fast/slow the text it displayed
import time
time.sleep(1)

#Welcome message to be user friendly
print("Welcome to my Virus Simulator Please answer the following. ")
...
def brand_new_day(country_to_help):
    print("NEW DAY")
    list_index = 0
    for country in name_of_countrys:
