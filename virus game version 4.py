...
def ask_which_country_to_support():
    #String which will display options for the user
    ...
    while True:
        ...
        #Check list of countrys to see if its an valid country
        for country in name_of_countrys:
...
def new_day(country_to_help):
    ...
    list_index = 0
    for country in name_of_countrys:
        # If the country is supported the percent of infected is deducted by 40%
        # If the country is at 40% or below, it cant go less than 0% of infected
        ...
        # If the country is at 80% or above, it cant go over 100% infected
        else:
        ...
        # Print the status of the each countrys
